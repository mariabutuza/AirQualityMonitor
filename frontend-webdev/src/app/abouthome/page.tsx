...
export default function AboutPageHome() {
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-teal-900 text-white px-6 pb-10">
            {/* Navbar */}
            <nav
                className="fixed top-0 left-0 right-0 z-50 bg-black/30 backdrop-blur-md border-b border-teal-500 text-white px-6 py-4 flex justify-between items-center shadow-md">
                ...
                <div className="space-x-4 hidden sm:flex">
                    ...
                    <a href="/abouthome" className="text-teal-400 underline font-semibold">Despre</a>
                    <button
                        onClick={() => {
            ...
            <div className="max-w-3xl mx-auto pt-24 space-y-12 text-gray-300 text-sm sm:text-base leading-relaxed">
                ...
                <section>
                    ...
                    <ul className="list-disc ml-6 mt-2 space-y-1 text-justify">
                        <li><strong>CO₂ (Dioxid de Carbon):</strong> provoacă oboseală, amețeli și dificultăți de
                            concentrare.
                        </li>
                        <li><strong>NH₃ (Amoniac):</strong> irită căile respiratorii și ochii, mai ales în zone
                            industriale.
                        </li>
                        <li><strong>Benzen:</strong> substanță cancerigenă prezentă în aerul urban și vaporii de
                            combustibil.
                        </li>
                        <li><strong>COV-uri & fum:</strong> compuși toxici care afectează sistemul respirator și pot
                            declanșa astm.
                        </li>
                    </ul>
                </section>
                ...
                <section>
                    <h2 className="text-2xl font-bold text-teal-400 mb-4 text-center">🌍 De ce e important să monitorizăm
                        aerul?</h2>

                    <p>
                        Poluarea aerului este una dintre cele mai mari amenințări globale asupra sănătății. Conform OMS,
                        peste <strong>7 milioane de oameni</strong> mor anual din cauza expunerii la particule fine și
                        gaze toxice.
                    ...
                    <p className="mt-4 text-center">
                        Monitorizarea constantă permite comunităților să evite expunerea, să protejeze grupele
                        vulnerabile
